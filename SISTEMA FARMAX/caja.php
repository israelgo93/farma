...
<table width="100%" border="0">
  <tr>
    ...
    <td width="46%" rowspan="2">
    	<pre><center>Nombre del Empleado : <?php echo $nombre_usu; ?></center></pre>
        <div align="right">
            ...
            <button type="button" class="<?php echo $mboton; ?>" onClick="window.location='php_caja.php?tventa=mayoreo'">P. Poveedor</button></strong>
        </div>
    </td>
  </tr>
  <tr>
...
<table width="00%" border="0" class="table table-hover">
  ...
  <tr>
	...
	if(($dato['exitencia']-$dato['cant'])>0){
	 ...
	 <td> 
	 <form id="form1" name="contado" method="get" action="remover.php">                 
        <input type="submit" class="btn btn-danger"  name="button" id="button" value="remover" />
     </form>
	 </td>
  <?php } ?>
